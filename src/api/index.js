...
// 此时我们需要获取三级联动的数据，看资料里面api前台接口文档中的首页三级分类
// 三级联动接口：/api/product/getBaseCategoryList    get请求方式  无需携带参数
// 对外暴露一函数，其他模块是可以拿到的，此时其他模块已调用这个函数求发起请求然后得到数据
...
// 删除购物产品的接口
//URL:/api/cart/deleteCart/{skuld}   method:DELETE
